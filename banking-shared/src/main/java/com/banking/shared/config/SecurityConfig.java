...
import com.banking.shared.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter, JwtAuthenticationEntryPoint unauthorizedHandler){
